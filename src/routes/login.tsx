        ...
        <div className="bg-white rounded-2xl shadow-xl border border-stone-100 overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-wood-800 to-wood-700 px-8 py-8 text-center text-white">
            ...
            <p className="text-stone-300 text-sm font-sans">
              Chào mừng trở lại, hỡi con cháu!
            </p>
          </div>

          <div className="px-8 py-8">
            {error && (
              <div className="bg-crimson-50 border border-crimson-200 text-crimson-700 rounded-xl px-4 py-3 text-sm mb-4 font-sans">
                {error}
              </div>
            )}
            {success && (
              <div className="bg-emerald-50 border border-emerald-200 text-emerald-700 rounded-xl px-4 py-3 text-sm mb-4 font-sans">
                {success}
              </div>
            )}
